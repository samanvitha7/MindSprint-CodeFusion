  ...
  {[ "Know More","Map", "About Us"].map((item, index) => (
    <li key={index} className="relative">
      ...
      <span className="absolute left-0 -bottom-1 w-0 h-1 bg-forest transition-all duration-300 hover:w-full rounded"></span>
        ...
        <button className="ml-10 px-6 py-2 rounded-lg bg-mint text-navy font-poppins font-semibold shadow-md transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 hover:bg-forest hover:text-soft hover:shadow-[0_0_15px_rgba(151,206,173,0.8)]">
          Scan Object
        </button>
      </nav>
    </header>
